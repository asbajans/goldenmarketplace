-- Run this in PostgreSQL to add columns for order system
-- Execute: docker exec -i <postgres-container> psql -U <user> -d <database> < migrate-order-system.sql

-- Add commission and shipping columns to stores
...
ALTER TABLE stores ADD COLUMN IF NOT EXISTS availableShippingCompanies JSON DEFAULT '["MNG Kargo"]';
